  ...
  return (
    <div class="page dashboard-page" id="dashboard-page">
      ...
      <div class="home-tab-bar">
        <button class="home-tab active" id="home-tab-today" onclick="switchHomeTab('today',this)">
          <i class="fas fa-bolt"></i> Today
        </button>
        <button class="home-tab" id="home-tab-mybook" onclick="switchHomeTab('mybook',this)">
          <i class="fas fa-book-open"></i> My Book
        </button>
      </div>
      ...
      {/* ══════════════════════════════════════════════════
          TODAY TAB PANE
          ══════════════════════════════════════════════════ */}
      <div class="home-tab-pane active" id="home-pane-today">

        {/* ── POLICY ALERT RIBBON ── */}
        <div class="pol-alert-ribbon" id="pol-alert-ribbon">
          <div class="par-icon"><i class="fas fa-bell"></i></div>
          <div class="par-alerts">
            <div class="par-alert par-urgent" onclick="navigateTo('policies');polSwitchTab('alerts')" title="Click to open Lapse &amp; Alerts tab">
              <i class="fas fa-exclamation-circle"></i>
              <span><strong>Patricia Nguyen</strong> — UL under-funded, lapse in ~68 days</span>
              <span class="par-chip urgent">Urgent</span>
            </div>
            <div class="par-alert par-high" onclick="navigateTo('policies');polSwitchTab('alerts')" title="Click to open Lapse &amp; Alerts tab">
              <i class="fas fa-calendar-times"></i>
              <span><strong>Sandra Williams</strong> — Term expiry Sep 15 · conversion window closing</span>
              <span class="par-chip high">High</span>
            </div>
            <div class="par-alert par-med" onclick="navigateTo('policies');polSwitchTab('alerts')" title="Click to open Lapse &amp; Alerts tab">
              <i class="fas fa-heartbeat"></i>
              <span><strong>James Whitfield</strong> — LTC coverage gap $180/day · review due</span>
              <span class="par-chip med">Med</span>
            </div>
          </div>
          <div class="par-cta">
            <button class="par-view-btn" onclick="navigateTo('policies');polSwitchTab('alerts')"><i class="fas fa-arrow-right"></i> View All 4</button>
            <button class="par-dismiss-btn" onclick="document.getElementById('pol-alert-ribbon').style.display='none'" title="Dismiss"><i class="fas fa-times"></i></button>
          </div>
        </div>
        ...
        <div class="kpi-grid">
          ...
          <div class="kpi-card" onclick="navigateTo('prospects')" style="cursor:pointer">
            <div class="kpi-icon red"><i class="fas fa-user-clock"></i></div>
            <div class="kpi-data">
              <div class="kpi-value">14</div>
              <div class="kpi-label">Active Prospects</div>
              <div class="kpi-trend up"><i class="fas fa-arrow-up"></i> $142K pipeline</div>
            </div>
          </div>
          <div class="kpi-card" onclick="navigateTo('reports')" style="cursor:pointer">
        ...
        <div class="book-snapshot-strip">
          ...
          <div class="bss-card bss-investments" onclick="navigateTo('inv-accounts')" style="cursor:pointer">
          ...
          <div class="bss-card bss-retirement" onclick="navigateTo('ret-accounts')" style="cursor:pointer">
          ...
          <div class="bss-card bss-advisory" onclick="navigateTo('adv-wealth')" style="cursor:pointer">
        ...
        {/* ── ROW A: Action Items + Today's Quick Wins ── */}
        <div class="dash-row-2col">
          ...
          <div class="dash-card">
            ...
            {/* Commission snapshot widget */}
            <div class="comm-widget-divider"></div>
            <div class="comm-widget">
              <div class="comm-widget-header">
                <span><i class="fas fa-wallet"></i> Commissions This Month</span>
                <button class="btn-link" onclick="switchHomeTab('mybook', document.getElementById('home-tab-mybook'))">Full View →</button>
              </div>
              <div class="comm-widget-total" onclick="openCommissionModal('monthly')" style="cursor:pointer">$42,180</div>
              <div class="comm-widget-meta">
                <span class="cwm-ytd">$187K YTD</span>
                <span class="cwm-sep">·</span>
                <span class="cwm-pct green-text">78% to target</span>
                <span class="cwm-sep">·</span>
                <span class="cwm-pending"><i class="fas fa-clock"></i> $8.4K pending</span>
              </div>
              <div class="comm-widget-bars">
                <div class="cwb-row"><span class="cwb-lbl"><i class="fas fa-circle" style="color:#003087;font-size:8px"></i> Ins</span><div class="cwb-outer"><div class="cwb-inner" style="width:55%;background:#003087"></div></div><span class="cwb-amt">$23.2K</span></div>
                <div class="cwb-row"><span class="cwb-lbl"><i class="fas fa-circle" style="color:#059669;font-size:8px"></i> Inv</span><div class="cwb-outer"><div class="cwb-inner" style="width:24%;background:#059669"></div></div><span class="cwb-amt">$10.1K</span></div>
                <div class="cwb-row"><span class="cwb-lbl"><i class="fas fa-circle" style="color:#d97706;font-size:8px"></i> Ret</span><div class="cwb-outer"><div class="cwb-inner" style="width:13%;background:#d97706"></div></div><span class="cwb-amt">$5.5K</span></div>
                <div class="cwb-row"><span class="cwb-lbl"><i class="fas fa-circle" style="color:#7c3aed;font-size:8px"></i> Adv</span><div class="cwb-outer"><div class="cwb-inner" style="width:8%;background:#7c3aed"></div></div><span class="cwb-amt">$3.4K</span></div>
              </div>
            </div>
          </div>
        ...
        {/* ── ROW B: Today & Upcoming + Lapse Risk Monitor ── */}
        <div class="dash-row-2col">
        ...
        {/* ── ROW C: Opportunity Radar + Monthly Goals ── */}
        <div class="dash-row-2col">
        ...
        <div class="market-monitor-panel" id="market-monitor-panel">
          ...
          <div class="mmp-sentiment-row">
            <div class="mmp-sent-card">
              ...
              <div class="mmp-sent-bar-wrap"><div class="mmp-sent-bar" style="width:72%;background:linear-gradient(90deg,#10b981,#059669)"></div></div>
              <div class="mmp-sent-score positive">72 / 100 — Positive</div>
            </div>
            <div class="mmp-sent-card">
              <div class="mmp-sent-label">Market Volatility Index</div>
              <div class="mmp-sent-bar-wrap"><div class="mmp-sent-bar" style="width:38%;background:linear-gradient(90deg,#f59e0b,#d97706)"></div></div>
              <div class="mmp-sent-score moderate">38 / 100 — Moderate</div>
            </div>
            <div class="mmp-sent-card">
              <div class="mmp-sent-label">Claims Risk Index</div>
              <div class="mmp-sent-bar-wrap"><div class="mmp-sent-bar" style="width:54%;background:linear-gradient(90deg,#f97316,#ea580c)"></div></div>
              <div class="mmp-sent-score elevated">54 / 100 — Elevated</div>
            </div>
            <div class="mmp-sent-card">
              <div class="mmp-sent-label">Renewal Opportunity</div>
              <div class="mmp-sent-bar-wrap"><div class="mmp-sent-bar" style="width:81%;background:linear-gradient(90deg,#3b82f6,#1d4ed8)"></div></div>
      ...
      </div>{/* end home-pane-today */}

      {/* ══════════════════════════════════════════════════
          MY BOOK TAB PANE
          ══════════════════════════════════════════════════ */}
      <div class="home-tab-pane" id="home-pane-mybook" style="display:none">

        {/* ── ROW 1: Book Composition + Commission Tracker (2-col) ── */}
        <div class="dash-row-2col">
        ...
        {/* ── ROW 2: Revenue by Product Line (full width) ── */}
        <div class="dash-card chart-card" style="margin-bottom:20px">
          <div class="card-header">
        ...
        {/* ── ROW 3: Top Clients (full width table) ── */}
        ...
        {/* ── ROW 4: Recent Communications (full width) ── */}
        <div class="dash-card" style="margin-bottom:20px">
          ...
          <div class="recent-comms recent-comms-grid">
      ...
      </div>{/* end home-pane-mybook */}

      {/* ── Market Monitor Full Modal (shared, outside panes) ── */}
...
function PoliciesPage() {
  return (
    <div class="page policies-page">
      ...
      {/* ── Persistent KPI bar — always visible ── */}
      <div class="policy-kpi-bar">
        <div class="pkpi-card pkpi-blue" onclick="polSwitchTab('list')">
        ...
        <div class="pkpi-card pkpi-orange" onclick="polSwitchTab('renewals')">
        ...
        <div class="pkpi-card pkpi-red" onclick="polSwitchTab('alerts')">
        ...
        <div class="pkpi-card pkpi-gold" onclick="polSwitchTab('overview')">
      ...
      <div class="pol-tab-bar">
        <button class="pol-tab pol-tab-active" id="pol-tab-overview"  onclick="polSwitchTab('overview')">
          <i class="fas fa-chart-pie"></i> Overview
        </button>
        <button class="pol-tab" id="pol-tab-list"     onclick="polSwitchTab('list')">
          <i class="fas fa-file-contract"></i> Policy List
          <span class="pol-tab-count">1,842</span>
        </button>
        <button class="pol-tab" id="pol-tab-alerts"   onclick="polSwitchTab('alerts')">
          <i class="fas fa-bell"></i> Lapse &amp; Alerts
          <span class="pol-tab-count pol-tab-count-red" id="pol-alerts-count">4</span>
        </button>
        <button class="pol-tab" id="pol-tab-renewals" onclick="polSwitchTab('renewals')">
          <i class="fas fa-sync-alt"></i> Renewals
          <span class="pol-tab-count pol-tab-count-orange">23</span>
        </button>
      </div>

      {/* ════════════════════════════════════════════════════
          TAB 1 — OVERVIEW
          Portfolio composition · AI actions · Service hub · Loan center
          ════════════════════════════════════════════════════ */}
      <div class="pol-tab-panel" id="pol-panel-overview">
        ...
        <div class="portfolio-health-strip">
          ...
          <div class="phs-bands">
            <div class="phs-band phs-wl">
              <div class="phs-band-header"><i class="fas fa-shield-alt"></i><span>Whole Life</span></div>
            ...
            <div class="phs-band phs-tl">
              <div class="phs-band-header"><i class="fas fa-clock"></i><span>Term Life</span></div>
            ...
            <div class="phs-band phs-ul">
              <div class="phs-band-header"><i class="fas fa-infinity"></i><span>Universal Life</span></div>
            ...
            <div class="phs-band phs-ltc">
              <div class="phs-band-header"><i class="fas fa-heartbeat"></i><span>LTC / Other</span></div>
        ...
        <div class="policy-ai-actions-bar">
          ...
          <button class="paa-btn paa-renewal" onclick="polSwitchTab('renewals')">
        ...
        {/* Conversion Alerts inline panel */}
        <div class="conversion-panel" id="conversion-panel" style="display:none">
          ...
          <div class="cvp-list" id="cvp-list"></div>
        </div>

        {/* Beneficiary Audit inline panel */}
        <div class="bene-audit-panel" id="bene-audit-panel" style="display:none">
          ...
          <div class="bap-list" id="bap-list"></div>
        </div>

        {/* Service Request Hub */}
        <div class="p7-service-hub-wrap">
          <div id="p7-service-hub"></div>
        ...
        {/* Loan & Cash Value Center */}
        <div id="p7-loan-center"></div>
      ...
      {/* ════════════════════════════════════════════════════
          TAB 2 — POLICY LIST
          Toolbar · 8-col table · expandable row detail
          ════════════════════════════════════════════════════ */}
      <div class="pol-tab-panel" id="pol-panel-list" style="display:none">

        {/* NLP banner — contextual to the list */}
        <div class="nlp-banner">
          ...
          <div class="nlp-banner-stats">
            <div class="nlp-stat"><span class="nlp-stat-val red">2</span><span class="nlp-stat-lbl">Urgent Risks</span></div>
            <div class="nlp-stat"><span class="nlp-stat-val orange">3</span><span class="nlp-stat-lbl">Clauses Flagged</span></div>
            <div class="nlp-stat"><span class="nlp-stat-val blue">8</span><span class="nlp-stat-lbl">Policies Scanned</span></div>
            <div class="nlp-stat"><span class="nlp-stat-val green">94%</span><span class="nlp-stat-lbl">NLP Accuracy</span></div>
          </div>
        ...
        <div class="page-toolbar">
          <div class="toolbar-left">
            <div class="search-inline-wrap">
              <i class="fas fa-search search-inline-icon"></i>
              <input type="text" id="policy-search" class="search-inline" placeholder="Search policies, clients…" oninput="filterPolicies()" />
            </div>
            ...
            <button class="btn btn-ghost" onclick="clearPolicyFilters()"><i class="fas fa-times"></i> Clear</button>
          </div>
          <div class="toolbar-right">
            <button class="btn btn-ai" onclick="openNLPReview('all')">
              <i class="fas fa-brain"></i> NLP Scan
            </button>
            <button class="btn btn-ghost" onclick="openRetentionFullReport()">
              <i class="fas fa-heartbeat"></i> Lapse Report
            </button>
        ...
        <table class="data-table" id="policies-table">
          ...
          <tbody>
            {mockPolicies.map(p => {
              ...
              return (
              <tr onclick={`openPolicyModal('${p.id}','view')`} class="pol-row-clickable">
                ...
                <td><div class={`lapse-risk-cell ${lapse.cls}`} onclick={lapse.retId ? `event.stopPropagation();openRetentionModal('${lapse.retId}')` : 'event.stopPropagation()'} title={lapse.trigger}><span class="lapse-score">{lapse.score}</span><span class="lapse-level-badge">{lapse.level}</span><div class="lapse-trigger-tip">{lapse.trigger}</div></div></td>
                <td><span class={`status-badge ${p.status.toLowerCase()}`}>{p.status}</span></td>
                <td><div class={`nlp-risk-cell ${nlp.cls}`} onclick={`event.stopPropagation();openNLPReview('${p.id}')`} title={nlp.flag}><span class="nlp-score">{nlp.score}</span><span class="nlp-level-badge">{nlp.level}</span><div class="nlp-flag-tip">{nlp.flag}</div></div></td>
        ...
        </div>{/* end policies-table-wrapper */}

      </div>{/* end pol-panel-list (Tab 2) */}

      {/* ════════════════════════════════════════════════════
          TAB 3 — LAPSE & ALERTS
          KPI strip · AI banner · filter tabs · two-col list+detail · timeline
          ════════════════════════════════════════════════════ */}
      <div class="pol-tab-panel" id="pol-panel-alerts" style="display:none">

        {/* KPI Strip */}
        <div class="alert-kpi-strip">
          <div class="alert-kpi-card alert-kpi-urgent" onclick="setAlertTab('urgent')">
            <div class="alert-kpi-icon"><i class="fas fa-exclamation-circle"></i></div>
            <div class="alert-kpi-body">
              <div class="alert-kpi-val">2</div>
              <div class="alert-kpi-lbl">Urgent Alerts</div>
              <div class="alert-kpi-sub">Action required now</div>
            </div>
          </div>
          <div class="alert-kpi-card alert-kpi-lapse" onclick="setAlertTab('lapse')">
            <div class="alert-kpi-icon"><i class="fas fa-heartbeat"></i></div>
            <div class="alert-kpi-body">
              <div class="alert-kpi-val">3</div>
              <div class="alert-kpi-lbl">Lapse Risk</div>
              <div class="alert-kpi-sub">High / Urgent policies</div>
            </div>
          </div>
          <div class="alert-kpi-card alert-kpi-renewal" onclick="setAlertTab('renewal')">
            <div class="alert-kpi-icon"><i class="fas fa-sync-alt"></i></div>
            <div class="alert-kpi-body">
              <div class="alert-kpi-val">23</div>
              <div class="alert-kpi-lbl">Renewals Due</div>
              <div class="alert-kpi-sub">Within 90 days</div>
            </div>
          </div>
          <div class="alert-kpi-card alert-kpi-premium" onclick="setAlertTab('premium')">
            <div class="alert-kpi-icon"><i class="fas fa-dollar-sign"></i></div>
            <div class="alert-kpi-body">
              <div class="alert-kpi-val">$14.1K</div>
              <div class="alert-kpi-lbl">Premium at Risk</div>
              <div class="alert-kpi-sub">From lapsing policies</div>
            </div>
          </div>
          <div class="alert-kpi-card alert-kpi-resolved">
            <div class="alert-kpi-icon"><i class="fas fa-check-circle"></i></div>
            <div class="alert-kpi-body">
              <div class="alert-kpi-val">8</div>
              <div class="alert-kpi-lbl">Resolved (30d)</div>
              <div class="alert-kpi-sub">Saved ~$22K premium</div>
            </div>
          </div>
        </div>
        ...
        <div class="alert-ai-banner">
          <div class="alert-ai-banner-left">
            <div class="alert-ai-icon"><i class="fas fa-robot"></i><span class="alert-ai-pulse"></span></div>
            <div>
              <div class="alert-ai-title">AI Lapse &amp; Alert Engine <span class="alert-ai-live">LIVE</span></div>
              <div class="alert-ai-sub">Real-time monitoring of 1,842 policies · predictive lapse scoring · automated retention triggers</div>
            </div>
          </div>
          <div class="alert-ai-actions">
            <button class="alert-btn-scan" onclick="runAlertScan()"><i class="fas fa-bolt"></i> Run Full Scan</button>
            <button class="alert-btn-export" onclick="exportAlertList()"><i class="fas fa-download"></i> Export</button>
          </div>
        </div>

        {/* Filter Tabs + List */}
        <div class="alert-filter-bar">
          <button class="alert-ftab alert-ftab-active" id="alert-ftab-all" onclick="setAlertTab('all')">All <span class="alert-ftab-count">4</span></button>
          <button class="alert-ftab" id="alert-ftab-urgent" onclick="setAlertTab('urgent')">Urgent <span class="alert-ftab-count red">2</span></button>
          <button class="alert-ftab" id="alert-ftab-lapse" onclick="setAlertTab('lapse')">Lapse Risk <span class="alert-ftab-count orange">3</span></button>
          <button class="alert-ftab" id="alert-ftab-renewal" onclick="setAlertTab('renewal')">Renewal <span class="alert-ftab-count blue">23</span></button>
          <button class="alert-ftab" id="alert-ftab-premium" onclick="setAlertTab('premium')">Premium <span class="alert-ftab-count purple">2</span></button>
        </div>

        {/* Two-column: list + detail */}
        <div class="alert-split-layout">
          <div class="alert-list-col" id="alert-list-col">
            {/* JS-populated via renderAlertList() */}
          </div>
          <div class="alert-detail-col" id="alert-detail-col">
            <div class="alert-detail-placeholder">
              <i class="fas fa-bell"></i>
              <p>Select an alert to view details &amp; recommended actions</p>
            </div>
          </div>
        </div>

        {/* Renewal Timeline */}
        <div class="alert-timeline-section">
          <div class="alert-timeline-header">
            <div class="alert-timeline-title"><i class="fas fa-stream"></i> Renewal Timeline — Next 90 Days</div>
            <button class="alert-timeline-btn" onclick="polSwitchTab('renewals')"><i class="fas fa-sync-alt"></i> Full Renewal Center</button>
          </div>
          <div class="alert-timeline-body" id="alert-renewal-timeline">
            {/* JS-populated via renderRenewalTimeline() */}
          </div>
        </div>

      </div>{/* end pol-panel-alerts (Tab 3) */}

      {/* ════════════════════════════════════════════════════
          TAB 4 — RENEWALS
          Renewal Action Center (full)
          ════════════════════════════════════════════════════ */}
      <div class="pol-tab-panel" id="pol-panel-renewals" style="display:none">

        {/* Renewal Action Center — moved from standalone to Tab 4 */}
      ...
      </div>{/* end pol-panel-renewals (Tab 4) */}
  ...
  return (
    <div class="page claims-page">
      ...
      <div class="pol-tab-panel" id="clm-panel-active" style="display:none">
        ...
        <div class="page-toolbar">
          <div class="toolbar-left">
            <div class="search-inline-wrap">
              <i class="fas fa-search search-inline-icon"></i>
              <input type="text" id="claim-search" class="search-inline" placeholder="Search claims, clients, policy IDs…" oninput="filterClaims()" />
            </div>
            ...
            <button class="btn btn-ghost" onclick="clearClaimFilters()"><i class="fas fa-times"></i> Clear</button>
          </div>
          <div class="toolbar-right">
        ...
        {/* 9-column slim table — clickable rows open claim detail modal */}
        <div class="claims-table-wrapper">
          <table class="data-table claims-table" id="claims-table">
            <thead>
              <tr>
                <th style="width:32px"><input type="checkbox" id="th-checkbox" /></th>
                <th>Claim ID</th>
                <th>Client</th>
                <th>Type</th>
            ...
            <tbody>
              {/* Row 1 — Robert Chen, Death Benefit, SLA breach */}
              <tr class="claim-row urgent clm-row-clickable" onclick="openClaimModal('CLM-2026-0041','view')">
                ...
                <td class="premium text-right">$1,000,000</td>
              ...
              {/* Row 2 — Sandra Williams, LTC */}
              <tr class="claim-row clm-row-clickable" onclick="openClaimModal('CLM-2026-0038','view')">
                <td onclick="event.stopPropagation()"><input type="checkbox" class="claim-row-checkbox" onchange="updateBatchButtons()" /></td>
                ...
                <td class="premium text-right">$18,000</td>
              ...
              {/* Row 3 — Maria Gonzalez, Disability */}
              <tr class="claim-row clm-row-clickable" onclick="openClaimModal('CLM-2026-0035','view')">
                <td onclick="event.stopPropagation()"><input type="checkbox" class="claim-row-checkbox" onchange="updateBatchButtons()" /></td>
                <td><span class="claim-id">CLM-2026-0035</span></td>
                <td><div class="client-cell"><div class="mini-avatar mg">MG</div><span>Maria Gonzalez</span></div></td>
                <td><span class="claim-type-badge disability">Disability</span></td>
                <td class="premium text-right">$4,200/mo</td>
              ...
              {/* Row 4 — James Whitfield, LTC */}
              <tr class="claim-row clm-row-clickable" onclick="openClaimModal('CLM-2026-0033','view')">
                <td onclick="event.stopPropagation()"><input type="checkbox" class="claim-row-checkbox" onchange="updateBatchButtons()" /></td>
                <td><span class="claim-id">CLM-2026-0033</span></td>
                <td><div class="client-cell"><div class="mini-avatar jw">JW</div><span>James Whitfield</span></div></td>
                <td><span class="claim-type-badge ltc">Long-term Care</span></td>
                <td class="premium text-right">$9,600</td>
              ...
              {/* Row 5 — Linda Morrison, Waiver */}
              <tr class="claim-row clm-row-clickable" onclick="openClaimModal('CLM-2026-0031','view')">
                <td onclick="event.stopPropagation()"><input type="checkbox" class="claim-row-checkbox" onchange="updateBatchButtons()" /></td>
                <td><span class="claim-id">CLM-2026-0031</span></td>
                <td><div class="client-cell"><div class="mini-avatar lm">LM</div><span>Linda Morrison</span></div></td>
                <td><span class="claim-type-badge waiver">Waiver of Premium</span></td>
                <td class="premium text-right">$9,600/yr</td>
              ...
              {/* Row 6 — Maria Gonzalez, ADB Compassionate */}
              <tr class="claim-row compassionate-row clm-row-clickable" onclick="openClaimModal('CLM-2026-0028','view')">
                <td onclick="event.stopPropagation()"><input type="checkbox" class="claim-row-checkbox" onchange="updateBatchButtons()" /></td>
                <td><span class="claim-id">CLM-2026-0028</span></td>
                <td><div class="client-cell"><div class="mini-avatar mg">MG</div><span>Maria Gonzalez <span class="compassionate-tag"><i class="fas fa-heart"></i></span></span></div></td>
                <td><span class="claim-type-badge accelerated">Accel. Benefit</span></td>
                <td class="premium text-right">$120,000</td>
              ...
              {/* Row 7 — Kevin Park, Death/Fraud Hold */}
              <tr class="claim-row clm-row-clickable" onclick="openClaimModal('CLM-2026-0025','view')">
                <td onclick="event.stopPropagation()"><input type="checkbox" class="claim-row-checkbox" onchange="updateBatchButtons()" /></td>
                ...
                <td><span class="claim-type-badge death">Death Benefit</span></td>
                <td class="premium text-right">$250,000</td>
      ...
      {/* ════════════════════════════════════════════════════════
          ...
          Recently Resolved table · Claims Performance Analytics
          ════════════════════════════════════════════════════════ */}
      <div class="pol-tab-panel" id="clm-panel-resolved" style="display:none">
          ...
          <table class="data-table claims-table">
            <thead>
              <tr>
                ...
                <th><i class="fas fa-tag" style="color:#64748b;margin-right:4px"></i>Category</th>
        ...
        <div class="cpa-panel" id="cpa-panel">
          ...
          <div class="cpa-body" id="cpa-body">
            <div class="cpa-kpi-row">
              <div class="cpa-kpi green"><div class="cpa-kpi-val">7</div><div class="cpa-kpi-lbl">Claims Active</div><div class="cpa-kpi-bench"><i class="fas fa-users"></i> Team avg: 5.2</div></div>
              <div class="cpa-kpi green"><div class="cpa-kpi-val">4</div><div class="cpa-kpi-lbl">Closed This Month</div><div class="cpa-kpi-bench"><i class="fas fa-users"></i> Team avg: 3.8</div></div>
              <div class="cpa-kpi blue"><div class="cpa-kpi-val">5.2d</div><div class="cpa-kpi-lbl">Avg Resolution Time</div><div class="cpa-kpi-bench"><i class="fas fa-users"></i> Team avg: 6.1d</div></div>
              <div class="cpa-kpi blue"><div class="cpa-kpi-val">3.1d</div><div class="cpa-kpi-lbl">Avg Payout Turnaround</div><div class="cpa-kpi-bench"><i class="fas fa-users"></i> Team avg: 3.8d</div></div>
              <div class="cpa-kpi orange"><div class="cpa-kpi-val">67%</div><div class="cpa-kpi-lbl">Doc Request Response Rate</div><div class="cpa-kpi-bench"><i class="fas fa-arrow-down" style="color:#dc2626"></i> Below 75% target</div></div>
              <div class="cpa-kpi green"><div class="cpa-kpi-val">93%</div><div class="cpa-kpi-lbl">SLA Compliance Rate</div><div class="cpa-kpi-bench"><i class="fas fa-check" style="color:#059669"></i> Above 90% target</div></div>
              <div class="cpa-kpi red"><div class="cpa-kpi-val">1</div><div class="cpa-kpi-lbl">SLA Breaches YTD</div><div class="cpa-kpi-bench"><i class="fas fa-users"></i> Team avg: 2.1</div></div>
              <div class="cpa-kpi purple"><div class="cpa-kpi-val">94%</div><div class="cpa-kpi-lbl">AI Triage Accuracy</div><div class="cpa-kpi-bench"><i class="fas fa-robot" style="color:#7c3aed"></i> AI-assisted</div></div>
            </div>
